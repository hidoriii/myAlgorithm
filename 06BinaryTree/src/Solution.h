...
public:
	...
	vector<string> binaryTreePaths(TreeNode *root);	  // 递归 + 回溯
	vector<string> binaryTreePaths_2(TreeNode *root); // 递归 + 回溯
	vector<string> binaryTreePaths_3(TreeNode *root); // 迭代法
...
private:
	...
	void traversal_2(TreeNode *cur, string path, vector<string> &result);
};
